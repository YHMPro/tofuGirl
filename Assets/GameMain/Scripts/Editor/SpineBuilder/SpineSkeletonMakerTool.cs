...
namespace GameEditor
{
    ...
    {
        private static string SkeletonPath = "Assets/GameMain/SpineAssets/";
        private static string DefaultAnimName = "idle";

        [MenuItem("[GameProject]/Res/Maker/Skeleton (Spine)/生成所有骨骼动画预设 (Spine)", false, 5)]
        ...
        [MenuItem("[GameProject]/Res/Maker/Skeleton (Spine)/生成选中骨骼动画预设 (Spine)", false, 6)]
