...
namespace Project.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        private const string DataTablePath = "Assets/GameMain/DataTables";//配置表读取路径
        private const string CSharpCodeNameSpace = "Project.TofuGirl";//CS命名空间
        private const string CSharpCodeClassNamePrefix = "DT";//CS类名前缀
        private const string CSharpCodePath = "Assets/GameMain/Scripts/DataTable";//配置数据表实体生成路径
        private const string CSharpCodeTemplateFileName = "Assets/GameMain/Configs/DataTableCodeTemplate.txt";//数据表代码模板
        ...
        public static void GenerateCodeFile(DataTableProcessor dataTableProcessor, string dataTableName)
        {
            ...
            string csharpCodeFileName = Utility.Path.GetRegularPath(Path.Combine(CSharpCodePath, CSharpCodeClassNamePrefix + dataTableName + ".cs"));
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_CLASS_NAME__", CSharpCodeClassNamePrefix + dataTableName);
